...
//! \file
//! \brief High-level graphics rendering interface.
...
//! \brief Destroy a render system.
void render_destroy(render_t* render);

//! \brief Push a model onto a queue of items to be rendered.
...
//! \brief Push an end-of-frame marker on a queue of items to be rendered.
